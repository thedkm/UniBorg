...
class Config(object):
    ...
    APP_ID = int(os.environ.get("APP_ID", 1657500))
    API_HASH = os.environ.get("API_HASH", "b8023a64794ea2e8559916a07d7783ad")
    ...
    PRIVATE_GROUP_BOT_API_ID = int(os.environ.get("PRIVATE_GROUP_BOT_API_ID", -1001474435061))
    # Send .get_id in any channel to fill this value. ReQuired for @Manuel15 inspiration to work!
    PRIVATE_CHANNEL_BOT_API_ID = int(os.environ.get("PRIVATE_CHANNEL_BOT_API_ID", -1001474435061))
    ...
    TG_BOT_TOKEN_BF_HER = os.environ.get("TG_BOT_TOKEN_BF_HER", 1370941155:AAH82XLepoOKlrX0mCjSsiva8pZ3ej-LL3s)
    TG_BOT_USER_NAME_BF_HER = os.environ.get("TG_BOT_USER_NAME_BF_HER", myuniborg_bot)
    #
    #
